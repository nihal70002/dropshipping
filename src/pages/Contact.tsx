              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">support@dropstore.com</p>
                    <p className="text-gray-600">sales@dropstore.com</p>
                  </div>
                </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-sm p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full flex items-center justify-center space-x-2 bg-orange-600 text-white py-4 rounded-full font-semibold hover:bg-orange-700 transition-colors duration-200"
                >
        ...
        <div className="mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-2xl shadow-sm p-6">
              ...
              <p className="text-gray-600">We offer a 30-day money-back guarantee...</p>
            </div>

            <div className="bg-white rounded-2xl shadow-sm p-6">
              <h3 className="font-semibold text-gray-900 mb-3">How long does shipping take?</h3>
              <p className="text-gray-600">Standard shipping typically takes 5-7 business days...</p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6">
              ...
              <p className="text-gray-600">Once your order ships, you'll receive a tracking number...</p>
            </div>
          </div>
        </div>
      </div>
